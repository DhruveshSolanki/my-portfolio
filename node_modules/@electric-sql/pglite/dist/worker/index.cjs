"use strict";var ue=Object.defineProperty;var Fe=Object.getOwnPropertyDescriptor;var Ve=Object.getOwnPropertyNames;var Qe=Object.prototype.hasOwnProperty;var Ee=e=>{throw TypeError(e)};var qe=(e,r)=>{for(var t in r)ue(e,t,{get:r[t],enumerable:!0})},ze=(e,r,t,n)=>{if(r&&typeof r=="object"||typeof r=="function")for(let i of Ve(r))!Qe.call(e,i)&&i!==t&&ue(e,i,{get:()=>r[i],enumerable:!(n=Fe(r,i))||n.enumerable});return e};var $e=e=>ze(ue({},"__esModule",{value:!0}),e);var pe=(e,r,t)=>r.has(e)||Ee("Cannot "+t);var a=(e,r,t)=>(pe(e,r,"read from private field"),t?t.call(e):r.get(e)),p=(e,r,t)=>r.has(e)?Ee("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),d=(e,r,t,n)=>(pe(e,r,"write to private field"),n?n.call(e,t):r.set(e,t),t),o=(e,r,t)=>(pe(e,r,"access private method"),t);var de=(e,r,t,n)=>({set _(i){d(e,r,i,t)},get _(){return a(e,r,n)}});var Vt={};qe(Vt,{LeaderChangedError:()=>ce,PGliteWorker:()=>Pe,worker:()=>Wt});module.exports=$e(Vt);var je=()=>typeof document>"u"?new URL(`file:${__filename}`).href:document.currentScript&&document.currentScript.src||new URL("main.js",document.baseURI).href,x=je();var Se={part:"part",container:"container"};function te(e,r,...t){let n=e.length-1,i=t.length-1;if(i!==-1){if(i===0){e[n]=e[n]+t[0]+r;return}e[n]=e[n]+t[0],e.push(...t.slice(1,i)),e.push(t[i]+r)}}function He(e,...r){let t=[e[0]];t.raw=[e.raw[0]];let n=[];for(let i=0;i<r.length;i++){let s=r[i],c=i+1;if(s?._templateType===Se.part){te(t,e[c],s.str),te(t.raw,e.raw[c],s.str);continue}if(s?._templateType===Se.container){te(t,e[c],...s.strings),te(t.raw,e.raw[c],...s.strings.raw),n.push(...s.values);continue}t.push(e[c]),t.raw.push(e.raw[c]),n.push(s)}return{_templateType:"container",strings:t,values:n}}function ye(e,...r){let{strings:t,values:n}=He(e,...r);return{query:[t[0],...n.flatMap((i,s)=>[`$${s+1}`,t[s+1]])].join(""),params:n}}var Ye=globalThis.JSON.parse,Ke=globalThis.JSON.stringify,Me=16,Ie=17;var ke=20,Je=21,Xe=23;var Ce=25,Ze=26;var De=114;var et=700,tt=701;var rt=1042,nt=1043,st=1082;var at=1114,Le=1184;var it=3802;var ot={string:{to:0,from:[Ce,nt,rt],serialize:e=>e,parse:e=>e},number:{to:0,from:[Je,Xe,Ze,et,tt],serialize:e=>e.toString(),parse:e=>+e},bigint:{to:ke,from:[ke],serialize:e=>e.toString(),parse:e=>{let r=BigInt(e);return r<Number.MIN_SAFE_INTEGER||r>Number.MAX_SAFE_INTEGER?r:Number(r)}},json:{to:De,from:[De,it],serialize:e=>Ke(e),parse:e=>Ye(e)},boolean:{to:Me,from:[Me],serialize:e=>{if(typeof e!="boolean")throw new Error("Invalid input for boolean type");return e?"t":"f"},parse:e=>e==="t"},date:{to:Le,from:[st,at,Le],serialize:e=>{if(typeof e=="string")return e;if(typeof e=="number")return new Date(e).toISOString();if(e instanceof Date)return e.toISOString();throw new Error("Invalid input for date type")},parse:e=>new Date(e)},bytea:{to:Ie,from:[Ie],serialize:e=>{if(!(e instanceof Uint8Array))throw new Error("Invalid input for bytea type");return"\\x"+Array.from(e).map(r=>r.toString(16).padStart(2,"0")).join("")},parse:e=>{let r=e.slice(2);return Uint8Array.from({length:r.length/2},(t,n)=>parseInt(r.substring(n*2,(n+1)*2),16))}}},fe=ct(ot),Oe=fe.parsers,ve=fe.serializers;function he(e,r,t){if(e===null)return null;let n=t?.[r]??fe.parsers[r];return n?n(e,r):e}function ct(e){return Object.keys(e).reduce(({parsers:r,serializers:t},n)=>{let{to:i,from:s,serialize:c,parse:y}=e[n];return t[i]=c,t[n]=c,r[n]=y,Array.isArray(s)?s.forEach(l=>{r[l]=y,t[l]=c}):(r[s]=y,t[s]=c),{parsers:r,serializers:t}},{parsers:{},serializers:{}})}var lt=/\\/g,ut=/"/g;function pt(e){return e.replace(lt,"\\\\").replace(ut,'\\"')}function ge(e,r,t){if(Array.isArray(e)===!1)return e;if(!e.length)return"{}";let n=e[0],i=t===1020?";":",";return Array.isArray(n)?`{${e.map(s=>ge(s,r,t)).join(i)}}`:`{${e.map(s=>(s===void 0&&(s=null),s===null?"null":'"'+pt(r?r(s):s.toString())+'"')).join(i)}}`}var me={i:0,char:null,str:"",quoted:!1,last:0,p:null};function Ue(e,r,t){return me.i=me.last=0,Ne(me,e,r,t)[0]}function Ne(e,r,t,n){let i=[],s=n===1020?";":",";for(;e.i<r.length;e.i++){if(e.char=r[e.i],e.quoted)e.char==="\\"?e.str+=r[++e.i]:e.char==='"'?(i.push(t?t(e.str):e.str),e.str="",e.quoted=r[e.i+1]==='"',e.last=e.i+2):e.str+=e.char;else if(e.char==='"')e.quoted=!0;else if(e.char==="{")e.last=++e.i,i.push(Ne(e,r,t,n));else if(e.char==="}"){e.quoted=!1,e.last<e.i&&i.push(t?t(r.slice(e.last,e.i)):r.slice(e.last,e.i)),e.last=e.i+1;break}else e.char===s&&e.p!=="}"&&e.p!=='"'&&(i.push(t?t(r.slice(e.last,e.i)):r.slice(e.last,e.i)),e.last=e.i+1);e.p=e.char}return e.last<e.i&&i.push(t?t(r.slice(e.last,e.i+1)):r.slice(e.last,e.i+1)),i}function be(e,r,t,n){let i=[],s={rows:[],fields:[]},c=0,y={...r,...t?.parsers},l=e.filter(u=>u.name==="rowDescription"||u.name==="dataRow"||u.name==="commandComplete");return l.forEach((u,m)=>{if(u.name==="rowDescription"){let T=u;s.fields=T.fields.map(b=>({name:b.name,dataTypeID:b.dataTypeID}))}else if(u.name==="dataRow"&&s){let T=u;t?.rowMode==="array"?s.rows.push(T.fields.map((b,L)=>he(b,s.fields[L].dataTypeID,y))):s.rows.push(Object.fromEntries(T.fields.map((b,L)=>[s.fields[L].name,he(b,s.fields[L].dataTypeID,y)])))}else u.name==="commandComplete"&&(c+=dt(u),m===l.length-1?i.push({...s,affectedRows:c,...n?{blob:n}:{}}):i.push(s),s={rows:[],fields:[]})}),i.length===0&&i.push({rows:[],fields:[]}),i}function dt(e){let r=e.text.split(" ");switch(r[0]){case"INSERT":return parseInt(r[2],10);case"UPDATE":case"DELETE":return parseInt(r[1],10);default:return 0}}function we(e){let r=e.find(t=>t.name==="parameterDescription");return r?r.dataTypeIDs:[]}function W(e){let r=e.length;for(let t=e.length-1;t>=0;t--){let n=e.charCodeAt(t);n>127&&n<=2047?r++:n>2047&&n<=65535&&(r+=2),n>=56320&&n<=57343&&t--}return r}var w,A,F,ne,V,P,re,G,_e,C=class{constructor(r=256){this.size=r;p(this,P);p(this,w);p(this,A,5);p(this,F,!1);p(this,ne,new TextEncoder);p(this,V,0);d(this,w,o(this,P,re).call(this,r))}addInt32(r){return o(this,P,G).call(this,4),a(this,w).setInt32(a(this,A),r,a(this,F)),d(this,A,a(this,A)+4),this}addInt16(r){return o(this,P,G).call(this,2),a(this,w).setInt16(a(this,A),r,a(this,F)),d(this,A,a(this,A)+2),this}addCString(r){return r&&this.addString(r),o(this,P,G).call(this,1),a(this,w).setUint8(a(this,A),0),de(this,A)._++,this}addString(r=""){let t=W(r);return o(this,P,G).call(this,t),a(this,ne).encodeInto(r,new Uint8Array(a(this,w).buffer,a(this,A))),d(this,A,a(this,A)+t),this}add(r){return o(this,P,G).call(this,r.byteLength),new Uint8Array(a(this,w).buffer).set(new Uint8Array(r),a(this,A)),d(this,A,a(this,A)+r.byteLength),this}flush(r){let t=o(this,P,_e).call(this,r);return d(this,A,5),d(this,w,o(this,P,re).call(this,this.size)),new Uint8Array(t)}};w=new WeakMap,A=new WeakMap,F=new WeakMap,ne=new WeakMap,V=new WeakMap,P=new WeakSet,re=function(r){return new DataView(new ArrayBuffer(r))},G=function(r){if(a(this,w).byteLength-a(this,A)<r){let n=a(this,w).buffer,i=n.byteLength+(n.byteLength>>1)+r;d(this,w,o(this,P,re).call(this,i)),new Uint8Array(a(this,w).buffer).set(new Uint8Array(n))}},_e=function(r){if(r){a(this,w).setUint8(a(this,V),r);let t=a(this,A)-(a(this,V)+1);a(this,w).setInt32(a(this,V)+1,t,a(this,F))}return a(this,w).buffer.slice(r?0:5,a(this,A))};var h=new C,yt=e=>{h.addInt16(3).addInt16(0);for(let n of Object.keys(e))h.addCString(n).addCString(e[n]);h.addCString("client_encoding").addCString("UTF8");let r=h.addCString("").flush(),t=r.byteLength+4;return new C().addInt32(t).add(r).flush()},mt=()=>{let e=new DataView(new ArrayBuffer(8));return e.setInt32(0,8,!1),e.setInt32(4,80877103,!1),new Uint8Array(e.buffer)},ft=e=>h.addCString(e).flush(112),ht=(e,r)=>(h.addCString(e).addInt32(W(r)).addString(r),h.flush(112)),gt=e=>h.addString(e).flush(112),bt=e=>h.addCString(e).flush(81),wt=[],At=e=>{let r=e.name??"";r.length>63&&(console.error("Warning! Postgres only supports 63 characters for query names."),console.error("You supplied %s (%s)",r,r.length),console.error("This can cause conflicts and silent errors executing queries"));let t=h.addCString(r).addCString(e.text).addInt16(e.types?.length??0);return e.types?.forEach(n=>t.addInt32(n)),h.flush(80)},Q=new C;var xt=(e,r)=>{for(let t=0;t<e.length;t++){let n=r?r(e[t],t):e[t];if(n===null)h.addInt16(0),Q.addInt32(-1);else if(n instanceof ArrayBuffer||ArrayBuffer.isView(n)){let i=ArrayBuffer.isView(n)?n.buffer.slice(n.byteOffset,n.byteOffset+n.byteLength):n;h.addInt16(1),Q.addInt32(i.byteLength),Q.add(i)}else h.addInt16(0),Q.addInt32(W(n)),Q.addString(n)}},Tt=(e={})=>{let r=e.portal??"",t=e.statement??"",n=e.binary??!1,i=e.values??wt,s=i.length;return h.addCString(r).addCString(t),h.addInt16(s),xt(i,e.valueMapper),h.addInt16(s),h.add(Q.flush()),h.addInt16(n?1:0),h.flush(66)},Pt=new Uint8Array([69,0,0,0,9,0,0,0,0,0]),Rt=e=>{if(!e||!e.portal&&!e.rows)return Pt;let r=e.portal??"",t=e.rows??0,n=W(r),i=4+n+1+4,s=new DataView(new ArrayBuffer(1+i));return s.setUint8(0,69),s.setInt32(1,i,!1),new TextEncoder().encodeInto(r,new Uint8Array(s.buffer,5)),s.setUint8(n+5,0),s.setUint32(s.byteLength-4,t,!1),new Uint8Array(s.buffer)},Bt=(e,r)=>{let t=new DataView(new ArrayBuffer(16));return t.setInt32(0,16,!1),t.setInt16(4,1234,!1),t.setInt16(6,5678,!1),t.setInt32(8,e,!1),t.setInt32(12,r,!1),new Uint8Array(t.buffer)},Ae=(e,r)=>{let t=new C;return t.addCString(r),t.flush(e)},Et=h.addCString("P").flush(68),St=h.addCString("S").flush(68),Mt=e=>e.name?Ae(68,`${e.type}${e.name??""}`):e.type==="P"?Et:St,It=e=>{let r=`${e.type}${e.name??""}`;return Ae(67,r)},kt=e=>h.add(e).flush(100),Dt=e=>Ae(102,e),se=e=>new Uint8Array([e,0,0,0,4]),Lt=se(72),Ct=se(83),Ot=se(88),vt=se(99),E={startup:yt,password:ft,requestSsl:mt,sendSASLInitialResponseMessage:ht,sendSCRAMClientFinalMessage:gt,query:bt,parse:At,bind:Tt,execute:Rt,describe:Mt,close:It,flush:()=>Lt,sync:()=>Ct,end:()=>Ot,copyData:kt,copyDone:()=>vt,copyFail:Dt,cancel:Bt};var pr=new ArrayBuffer(0);var Nt=1,_t=4,Jr=Nt+_t,Xr=new ArrayBuffer(0);var $,D,f,I,ae,O,xe,ie=class{constructor(){p(this,f);this.serializers={...ve};this.parsers={...Oe};p(this,$,!1);p(this,D,!1)}async _initArrayTypes(){if(a(this,$))return;d(this,$,!0);let r=await this.query(`
